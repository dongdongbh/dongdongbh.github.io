...
tags:
 - note
description: "Study notes on Sergey Levine's deep reinforcement learning lectures, including model-based methods and meta-learning, with a downloadable PDF."
---
...
every sample has a $\mu_i,\sigma_i$. When you have many samples, the total parameters are $ \lvert \theta \rvert + ( \lvert \mu_i \rvert + \lvert \sigma_i \rvert )N$
