...
&=E_{(s_{1:T},a_{1:T})\sim q}\left[\sum_tr(s_t,a_t)-\log q(a_t \mid s_t)\right]\\
...
&=\frac{\exp(\sum_tr_\psi(s_t,a_t))}{\prod_t\pi(a_t \mid s_t)}
\end{align}
$$
...
$$
\pi(a \mid s,z) =\arg \max_\pi \sum_z E_{s \sim \pi(s \mid z)}[r(a,z)]$
$$
