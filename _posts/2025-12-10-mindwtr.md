...
description: Introducing Mindwtr - a free, open-source productivity app implementing the Getting Things Done methodology
---
...
**Mindwtr** is a free, open-source productivity app that implements the GTD methodology. It features:
...
![Desktop App](/assets/images/posts/mindwtr-desktop.png)
*Desktop app - Inbox view*

|                    Weekly Review                     |                        Board View                         |                            Settings                             |
| :--------------------------------------------------: | :-------------------------------------------------------: | :-------------------------------------------------------------: |
| ![Review](/assets/images/posts/mindwtr-mobile.png) | ![Board](/assets/images/posts/mindwtr-mobile-board.png) | ![Settings](/assets/images/posts/mindwtr-mobile-settings.png) |

---

### **Get Mindwtr**

**GitHub Repository**: [https://github.com/dongdongbh/Mindwtr](https://github.com/dongdongbh/Mindwtr)

**Downloads**:
- **Linux**: Available on AUR (`yay -S mindwtr-bin`) or download AppImage/deb
- **macOS/Windows**: Download from [Releases](https://github.com/dongdongbh/Mindwtr/releases)
...
If you're looking for a free, open-source GTD app that respects your data and your privacy, give Mindwtr a try.
