---
0title: "Transparent proxy on Linux with V2ray and clash"
classes: wide
sitemap: true
categories:
  - Blog
...
<img src="../assets/images/tproxy/iptable.webp" width="70%">
...
This method is the REDIRECT method, their is a TPROXY method for V2ray, but I didn't make it works on my machine, if you instrested, see [̧here](https://toutyrater.github.io/app/tproxy.html)
