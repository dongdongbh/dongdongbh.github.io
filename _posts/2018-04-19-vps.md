...
**Network freedom** is demanding for everyone, especially for programmers and researchers. However, because of the reason everyone knows, there is a barrier in Chinese mainland towards some sites. At the beginning, This is only a note for myself about how to cross the barrier, but many my friends ask me how to have network freedom in China, so I revised this post and make things more clear and easy to understand. I hope this post can help you in learning and developing. As an individual person, we must have the ability to distinguish what information on the Internet should trust. And here, I **claim** that this post is only for learning and research.
