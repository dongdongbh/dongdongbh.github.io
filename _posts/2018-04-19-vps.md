---
title: "Using Google cloud to build a Virtual Private Server (VPS), set up ssr and v2ray"
classes: wide
sitemap: true
categories:
  - Blog
...
Please refer the [v2ray](<https://www.v2ray.com/>) official website for detail. For more brainless method, refer [toutyrater](<https://toutyrater.github.io/>)
