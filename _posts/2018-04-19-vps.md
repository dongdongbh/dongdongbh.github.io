...
Refer [here](<https://toutyrater.github.io/advanced/wss_and_web.html>) for detail configuration of v2ray client and server. If you add `location` to your orignal Nginx server , then the client port will be 443, or you can add a new server using a different port (e.g. 8080) in you Nginx configuration.
