...
description: "Set up a Nebula overlay network with a public lighthouse server, then use Syncthing to synchronize files between a Linux PC and an Android phone."
---
